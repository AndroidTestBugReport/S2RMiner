...
if __name__ == '__main__':
    ...
    word2Idx=np.load('word2Idx_step.npy', allow_pickle=True)
    ...
    testFolder='buildDataSet/'+'recdroid-test'
    
    model=load_model("keras_model_step.h5")
    model.summary()
    #####################test##############################
    ...
    targetFolder="recdroid-labeled-by-model/step"
