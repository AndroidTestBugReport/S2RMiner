...
def fillComments(contents, i, TestBol,sent5Text):
    ...
    sent5.append(word2VecArray(item1))
    sent5.append(word2VecArray(item2))
    sent5.append(word2VecArray(item3))
    sent5.append(word2VecArray(item4))
    sent5.append(word2VecArray(item5))
    ...
    for fileName in pathDir:
        ...
        for i in range(0,len(contents)-1):
            ...
            if titleTag==True:#this is for the title
                sent5.append(word2VecArray("#####title#12345#"))
                sent5.append(word2VecArray("#####title#12345#"))
                sent5.append(word2VecArray("#####title#12345#"))
                sent5.append(word2VecArray("#####title#12345#"))
                sent5.append(word2VecArray(contents[i]))
...
if __name__ == '__main__':
    ...
    sents_input = Input(shape=(5,Maxwordsent,vectorSize), name='sents_input')
    conv1d_out= TimeDistributed(Conv1D(kernel_size=3, filters=Maxwordsent, padding='same',activation='tanh', strides=1))(sents_input) #(None, None, 52, 30) filters is the kernel number, it decide output how many vecters
    ...
    ################################3we need to release the memory
    del allTrainX
    del allTrainY
    gc.collect()
    ...
    outputFile.write("no_embeding_cnn_lstm\n")
