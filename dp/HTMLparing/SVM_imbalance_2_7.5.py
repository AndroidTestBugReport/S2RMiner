...
def fillComments(contents, i):
    ...
    #sent5=np.append(sent5,doc2VecTrans(item1))
    #sent5=np.append(sent5,doc2VecTrans(item2))
    #sent5=np.append(sent5,doc2VecTrans(item3))
    #sent5=np.append(sent5,doc2VecTrans(item4))
    sent5=np.append(sent5,doc2VecTrans(item5))
    ...
    for fileName in pathDir:
        ...
        for i in range(0,len(contents)-1):
            ...
            if titleTag==True:#this is for the title
                #sent5=np.append(sent5,doc2VecTrans("#####title#12345#"))
                #sent5=np.append(sent5,doc2VecTrans("#####title#12345#"))
                #sent5=np.append(sent5,doc2VecTrans("#####title#12345#"))
                #sent5=np.append(sent5,doc2VecTrans("#####title#12345#"))
                sent5=np.append(sent5,doc2VecTrans(contents[i]))
